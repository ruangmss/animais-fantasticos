...
O projeto foi construído "do zero", sem o uso de frameworks, focando na base do desenvolvimento web:

- **HTML5:** Estruturação semântica.
- **CSS3:** Layout com Flexbox e CSS Grid.
- **JavaScript (ES6+):** Lógica, interatividade e organização modular.

---

## 🎨 Design e Identidade Visual

O projeto utiliza uma estética de "catálogo científico", através de sua tipografia e cores
